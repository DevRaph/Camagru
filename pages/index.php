			...
			<div class="form">
				...
				<form enctype="multipart/form-data" action="<?= ROOT ?>/save_image.php" method="POST">
					...
					<div class="form-input">
						...
						<div class="input" id="input-choose-picture">
							<input id='input_image' class='input-file' onchange='readURL(this)' type='file' name='files' alt="no image"/>
                            <div class="submit">
                                <button id='shot' class='btn' class="btn" style="float:right" type="submit">Uploader</button>
                            </div>
							<img id='preupload' src='#' alt='selected_filter' style='width:100%; margin:10px auto; display:block; color:white;' />
						</div>
					</div>
				</form>
				<br clear="both">
