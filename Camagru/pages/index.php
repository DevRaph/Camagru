...
<script type="text/javascript">
	...
	if (view_file) 
	{
		view_file.onclick = function () {
			var block_video = document.querySelector("#block_video");
			block_video.innerHTML = "<div class=\"put_file\"> <form method=\"POST\" action=\"save_image.php\" enctype=\"multipart/form-data\"> <input id=\"input_image\" class=\"input-file\" type=\"file\" name=\"files\"> <button id=\"shot\" class=\"btn\">Uploader</button> </form> <br clear=\"both\"> </div>";
		}
	}
